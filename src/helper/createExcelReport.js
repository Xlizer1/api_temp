...
module.exports = {
  ...
  createMissionsExcelReport: async function createMissionsExcelReport(
    data,
    file_name,
    filterType
  ) {
  ...
  externalCustomerCareAndInstallationTasksExcelReport:
    async function createExcelReport(data, file_name) {
      //console.log("inside excelfunction")
      //console.log(data)
  ...
  creatMissionPdf: async function creatMissionPdf(
    data,
    file_name,
    filterType,
    dataForDate
    ...
    try {
      ...
      data.forEach(function (row) {
        ...
        rowValues = {
          ...
          // 'customer_location':'',
          internal_technicians: json.engineers_names
            ? json.engineers_names
            : "",
          external_technicians: json.technicians_names
            ? json.technicians_names
            : "",
          location: json.geofence_name ? json.geofence_name : "",
          mission_type: json.mission_type_names ? json.mission_type_names : "",
          instructions: json.instructions
            ? json.instructions.replace(/\s+/g, " ")
            : "",
  ...
  createLeaveRequestExcelReport: async function createLeaveRequestExcelReport(
    data,
    file_name,
    filterType
  ) {
    ...
    data.forEach(function (row) {
      ...
      rowValues[7] = row.from_day_date
        ? getDateTime(row.from_day_date, "Y-m-d")
        : "";
      rowValues[8] = row.to_day_date
        ? getDateTime(row.to_day_date, "Y-m-d")
        : "";
      rowValues[9] = row.created_at
        ? getDateTime(row.created_at, "Y-m-d H:M:S")
        : "";
      // add row to worksheet
      worksheet.addRow(rowValues);
    });
  ...
  creatLeaveRequestPdf: async function creatLeaveRequestPdf(
    data,
    file_name,
    filterType,
    dataForDate
      ...
      data.forEach(function (row) {
        ...
        rowValues = {
          ...
          supervisor_comment: row.supervisor_comment
            ...
            : "",
          from_day_date: row.from_day_date
            ? getDateTime(row.from_day_date, "Y-m-d")
            : "",
          to_day_Date: row.to_day_Date
            ? getDateTime(row.to_day_Date, "Y-m-d")
            : "",
  ...
  createSubMissionsExcelReport: async function createSubMissionsExcelReport(
    data,
    file_name,
    filterType
  ) {
  ...
  creatSubMissionsReportPDF: async function creatSubMissionsReportPDF(
    data,
    file_name,
    filterType,
    dataForDate
  ...
  createInventoryRequestExcelReport:
    async function createInventoryRequestExcelReport(
      data,
      file_name,
      filterType
    ) {
  ...
  creatInventoryRequestPdf: async function creatInventoryRequestPdf(
    data,
    file_name,
    filterType,
    dataForDate
  ...
  createUserOverTimeExcelReport: async function createUserOverTimeExcelReport(
    data,
    file_name,
    filterType
  ) {
  ...
  createUserOverTimePdf: async function createUserOverTimePdf(
    data,
    file_name,
    filterType,
    dataForDate
  ...
  createCustomerCareExcelReport: async function createCustomerCareExcelReport(
    data,
    file_name,
    filterType
  ) {
  ...
  createCustomerCarePdf: async function createCustomerCarePdf(
    data,
    file_name,
    filterType,
    dataForDate
  ...
  //genral task here..
  createExcelReport: async function createExcelReport(
    data,
    file_name,
    filterType
  ) {
  ...
  createPdfReport: async function createPdfReport(
    data,
    file_name,
    filterType,
    dataForDate
  ...
  //installation tasks
  createInstallationExcelReport: async function createInstallationExcelReport(
    data,
    file_name,
    filterType,
    is_special_export = 0
  ...
  createInstallationReportPdf: async function createInstallationReportPdf(
    data,
    file_name,
    filterType,
    dataForDate,
  ...
  usersExcelReport: async function usersExcelReport(
    data,
    file_name,
    filterType
  ) {
    ...
    data.forEach(function (row) {
      ...
      rowValues[8] = row.patients_per_day;
  ...
  usersReportPdf: async function usersReportPdf(
    data,
    file_name,
    filterType,
    dataForDate
      ...
      data.forEach(function (row) {
        ...
        rowValues = {
          ...
          last_login: row.last_login
            ? getDateTime(row.last_login, "Y-m-d H:M:S")
            : "",
          patients_per_day: row.patients_per_day ? row.patients_per_day : "",
  ...
  complainExcelReport: async function complainExcelReport(
    data,
    file_name,
    filterType
  ) {
  ...
  complainReportPdf: async function complainReportPdf(
    data,
    file_name,
    filterType,
    dataForDate
      ...
      data.forEach(function (row) {
        ...
        rowValues = {
          ...
          description: row.created_at
            ? getDateTime(row.created_at, "Y-m-d")
            : "",
        };
        listOfData.push(rowValues);
      });
  ...
  createSubMissionOvertTimeExcelReport:
    async function createSubMissionOvertTimeExcelReport(
      data,
      file_name,
      filterType
    ) {
  ...
  createSubMissionOvertTimePdf: async function createSubMissionOvertTimePdf(
    data,
    file_name,
    filterType,
    dataForDate
    ...
    try {
      ...
      data.forEach(function (row) {
        ...
        rowValues = {
          ...
          status: row.sub_mission_status_name
            ? row.sub_mission_status_name
            : "",
  ...
  taskMissionSubmissionMonitoringExcelReport: async function excelReport(
    data,
    file_name,
    filterType
  ) {
    ...
    data.forEach(function (row) {
      ...
      rowValues[11] = row.erp_report_status
        ? row.erp_report_status
        : "no report";
  ...
  taskMissionSubmissionMonitoringExcelReportUnlinked:
    async function excelReport(data, file_name, filterType) {
      const excel_file_path =
        __dirname +
        "/../../dist/uploads/temp/excel_reports/" +
        file_name +
      ...
      data.forEach(function (row) {
        ...
        rowValues[2] = row.Status;
        rowValues[3] =
          row.ReportDate && row.ReportDate.date ? row.ReportDate.date : null;
  ...
  taskMissionSubmissionMonitoringExcelPDF: async function pdfReport(
    data,
    file_name,
    filterType
  ) {
      ...
      data.forEach(function (row) {
        ...
        rowValues = {
          ...
          mission_date: row?.mission_date
            ? getDateTime(row.mission_date, "Y-m-d")
            : "",
          sub_mission_id: row.sub_mission_id ? row.sub_mission_id : "",
          sub_mission_name: row.sub_mission_name ? row.sub_mission_name : "",
          sub_mission_date: row?.sub_mission_date
            ? getDateTime(row.sub_mission_date, "Y-m-d")
            : "",
          customer_name: row.customer_name ? row.customer_name : "",
          eng_names: eng_names,
          tech_names: tech_names,
          erp_report_number: row.erp_report_number ? row.erp_report_number : "",
          erp_report_date: row.erp_report_date
            ? getDateTime(row.erp_report_date, "Y-m-d")
            : "",
          erp_report_status: row.erp_report_status
            ? row?.erp_report_status
            : "no report",
        };
        listOfData.push(rowValues);
  ...
  taskMissionSubmissionMonitoringExcelPDFUnlinked: async function pdfReport(
    data,
    file_name,
    filterType
  ) {
    try {
      ...
      data.forEach(function (row) {
        ...
        rowValues = {
          ...
          Status: row?.Status ? row.Status : "",
          ReportDate:
            row.ReportDate && row.ReportDate.date
              ? getDateTime(row.ReportDate.date, "Y-m-d")
              : null,
  ...
  taskLogExcelReport: async function taskLogExcelReport(
    data,
    file_name,
    filterType
  ) {
  ...
  taskLogsReportPdf: async function pdfReport(data, file_name, filterType) {
    function getdifferent(start, end) {
      ...
      let result = calculateTimeDifference(new Date(start), new Date(end));
      let finalResult = "";
      if (result?.hours) {
  ...
  createDNDMissionsExcelReport: async function createStyledMissionsExcelReport(
    data,
    file_name,
    filterType
  ) {
    ...
    data?.forEach(function (row) {
      ...
      rowValues[5] = json.technician_names
        ? json.technician_names.replace(/,/g, "\n")
        : "";
  ...
  createDNDMissionsReportPdf: async function pdfReport(
    data,
    file_name,
    filterType
  ) {
  ...
  createSubMissionsMonitoringExcelReport:
    async function createSubMissionsMonitoringExcelReport(
      data,
      file_name,
      filterType
    ) {
  ...
  createSubMissionsMonitoringPDFReport: async function pdfReport(
    data,
    file_name,
    filterType
  ) {
  ...
  mizanListStatusDetailsExport: async function mizanListStatusDetailsExport(
    data,
    file_name,
    filterType
  ) {
  ...
  mizanListStatusDetailsExportPdf: async function exportPdf(
    data,
    file_name,
    filterType,
    dataForDate
    ...
    try {
      ...
      data.forEach(function (row) {
        ...
        rowValues = {
          ...
          date_time_empty: row.date_time_empty
            ? getDateTime(row.date_time_empty, "Y-m-d H:M:S")
            : "",
          date_time_full: row.date_time_full
            ? getDateTime(row.date_time_full, "Y-m-d H:M:S")
            : "",
          ...
          last_updated_date: row.last_updated_date
            ? getDateTime(row.last_updated_date, "Y-m-d")
            : "",
        };
        listOfData.push(rowValues);
      });
